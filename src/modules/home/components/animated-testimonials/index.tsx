...
function StarIcon({ filled }: { filled: boolean }) {
  return (
    <svg className={`w-4 h-4 ${filled ? "text-gold" : "text-gray-300 dark:text-white/20"}`} fill="currentColor" viewBox="0 0 20 20">
...
export default function AnimatedTestimonialsSection() {
  return (
    <section className="relative py-14 md:py-20 bg-white dark:bg-ink">

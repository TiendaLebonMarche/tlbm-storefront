            ...
            <ul className="space-y-3">
              ...
              <li className="mt-8">
                ...
                <div className="flex">
                  ...
                  <button className="px-6 py-3 rounded-r-full text-[10px] font-bold uppercase tracking-[.18em] border-none cursor-pointer text-white bg-[#D4AF37] hover:bg-[#C8912E] transition-all duration-300 min-h-[48px]">OK</button>
                </div>
              </li>
            </ul>
          </div>

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16 mb-14 reveal justify-items-center">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <ul className="space-y-3">
              ...
              <li><LocalizedClientLink href="/guias" className="text-sm text-white/75 hover:text-[#D4AF37] transition-all duration-300 hover:translate-x-1 inline-block">FAQ</LocalizedClientLink></li>
            </ul>
          </div>

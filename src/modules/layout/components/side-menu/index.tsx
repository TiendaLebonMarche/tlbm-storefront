                  ...
                  >
                    ...
                    <ul className="flex flex-col items-start justify-start flex-1 w-full">
                      ...
                      <li className="w-full group overflow-hidden border-b border-gray-50">
                        <LocalizedClientLink
                          href="/"
                          className="block w-full text-3xl md:text-[34px] font-serif font-medium py-4 text-brand-black transform transition-all duration-700 group-hover:translate-x-2 group-hover:text-gold tracking-tight"
                      ...
                      <li className="w-full group overflow-hidden border-b border-gray-50">
                        <div className="flex items-center">
                          <LocalizedClientLink
                            href="/collections"
                            className="flex-1 block text-3xl md:text-[34px] font-serif font-medium py-4 text-brand-black transform transition-all duration-700 group-hover:translate-x-2 group-hover:text-gold tracking-tight"
                          ...
                          <button
                            ...
                            className="p-4 text-brand-gray hover:text-gold transition-colors duration-300"
                        ...
                        {collectionsOpen && (
                          <ul className="pb-5 pl-1 space-y-0.5">
                            <li>
                              <LocalizedClientLink
                                href="/collections"
                                className="block text-[11px] font-bold uppercase tracking-[0.2em] text-gold py-2 hover:opacity-70 transition-opacity"
                                onClick={() => { close(); closeSideMenu(); }}
                              >
                            ...
                            {collections.map((c) => (
                              <li key={c.id}>
                                <LocalizedClientLink
                                  ...
                                  className="block text-base font-light text-brand-black/80 py-1.5 hover:text-gold hover:translate-x-1 transition-all duration-300"
                                  onClick={() => { close(); closeSideMenu(); }}
                                >
                                  {c.title}
                                </LocalizedClientLink>
                        ...
                        <div className="flex gap-4">
                          {socials.map((s) => (
                            <a
                              ...
                              rel="noopener noreferrer"
                              aria-label={s.name}
                              className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-brand-gray hover:text-white hover:bg-ink hover:border-ink transition-all duration-300"
                            >

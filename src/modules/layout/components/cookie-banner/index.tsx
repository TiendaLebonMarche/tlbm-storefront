  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="w-full max-w-3xl bg-brand-black/90 backdrop-blur-xl shadow-2xl rounded-xs p-4 md:p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 pointer-events-auto border border-white/10">

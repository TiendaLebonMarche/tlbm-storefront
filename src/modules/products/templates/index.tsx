            ...
            <div className="space-y-6 pb-8 border-b border-white">
              <div className="space-y-4">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {isNew && (
                    <span className="text-[8px] font-bold uppercase tracking-[0.2em] px-2 py-1 bg-brand-black text-white font-sans rounded-xs ml-auto">
                      Recién llegado
                    </span>
                  )}
                </div>
            ...
            <div className="py-8 grid grid-cols-2 gap-x-8 gap-y-6">
              {[
                ...
                <div key={i} className="flex items-start gap-4 group/trust">
                  <div className="shrink-0 text-brand-black/30 group-hover/trust:text-brand-black transition-colors duration-200 mt-0.5">
                    {item.icon}
                  </div>
                  <div className="space-y-0.5">
                    <p className="text-[10px] font-bold text-brand-black font-sans uppercase tracking-widest">{item.label}</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-x-8 xl:gap-x-16">
              ...
              <div className="lg:col-span-7">
                <div className="mb-12">
                  ...
                  <h2 className="text-3xl md:text-4xl font-serif font-semibold text-brand-black leading-[1.15] tracking-[-0.015em] text-balance">Detalles que marcan <span className="bg-linear-to-r from-[#D4AF37] to-[#D4AF37]/70 bg-clip-text text-transparent">la diferencia</span></h2>
                </div>
              ...
              <div className="lg:col-span-5 flex flex-col space-y-12">
                <div className="mb-12 lg:mb-16">
                  ...
                  <h3 className="text-2xl md:text-3xl font-serif font-semibold text-brand-black leading-[1.15] tracking-[-0.015em] text-balance">Servicio al <span className="bg-linear-to-r from-[#D4AF37] to-[#D4AF37]/70 bg-clip-text text-transparent">cliente</span></h3>
                </div>

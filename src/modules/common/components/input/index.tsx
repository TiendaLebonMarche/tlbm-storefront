      ...
      <div className="flex flex-col w-full group">
        ...
        <div className="flex relative z-0 w-full txt-compact-medium">
          <input
            ...
            required={required}
            className={clx(
              "pt-6 pb-2 block w-full h-14 px-6 mt-0 bg-white border-2 rounded-3xl appearance-none focus:outline-hidden focus:ring-4 focus:ring-brand-black/10 border-brand-gray-light focus:border-brand-black transition-all duration-300 shadow-xs peer",
              className
            )}
            {...props}
            ref={inputRef}

        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-32">
          ...
          <main className="lg:w-3/4 max-w-3xl">
            ...
            <div className="prose prose-lg prose-headings:font-serif prose-headings:text-[#000000] prose-headings:font-bold prose-headings:tracking-tight prose-p:text-brand-gray prose-p:font-light prose-p:leading-loose text-brand-gray max-w-none [&_h2]:font-serif [&_h2]:font-bold [&_h2]:text-[#000000] [&_h2]:tracking-tight [&_p]:text-brand-gray [&_p]:font-light [&_p]:leading-loose">
              ...
              <h2 className="text-3xl mt-12 mb-6">Identificación del Comerciante</h2>
              <p>
              ...
              <h2 className="text-3xl mt-12 mb-6">Contratación Electrónica — Ley 527 de 1999</h2>
              <p>
              ...
              <h2 className="text-3xl mt-12 mb-6">Uso del Sitio y Algoritmos</h2>
              <p>
              ...
              <h2 className="text-3xl mt-12 mb-6">Facturación Electrónica</h2>
              <p>
              ...
              <h2 className="text-3xl mt-12 mb-6">Reversión de Pago y Seguridad</h2>
              <p>
              ...
              <h2 className="text-3xl mt-12 mb-6">Propiedad Intelectual</h2>
              <p>
              ...
              <h2 className="text-3xl mt-12 mb-6">Autoridad de Vigilancia y Ley Aplicable</h2>
              <p>
